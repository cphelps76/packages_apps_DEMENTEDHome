...
package com.android.cphelps76.backup;
...
public final class BackupProtos {
  ...
  public static final class Journal extends
    ...
    public com.android.cphelps76.backup.BackupProtos.Key[] key = com.android.cphelps76.backup.BackupProtos.Key.EMPTY_ARRAY;
    ...
    public final Journal clear() {
      ...
      bytes = 0L;
      rows = 0;
      key = com.android.cphelps76.backup.BackupProtos.Key.EMPTY_ARRAY;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      for (com.android.cphelps76.backup.BackupProtos.Key element : this.key) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            com.android.cphelps76.backup.BackupProtos.Key[] newArray = new com.android.cphelps76.backup.BackupProtos.Key[i + arrayLength];
            System.arraycopy(this.key, 0, newArray, 0, i);
            this.key = newArray;
            for (; i < this.key.length - 1; i++) {
              this.key[i] = new com.android.cphelps76.backup.BackupProtos.Key();
  ...
  public static final class Widget extends
    ...
    public com.android.cphelps76.backup.BackupProtos.Resource icon = null;
    
    // optional .launcher_backup.Resource preview = 5;
    public com.android.cphelps76.backup.BackupProtos.Resource preview = null;
    ...
    public Widget mergeFrom(
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 34: {
            this.icon = new com.android.cphelps76.backup.BackupProtos.Resource();
            input.readMessage(this.icon);
            break;
          }
          case 42: {
            this.preview = new com.android.cphelps76.backup.BackupProtos.Resource();
