...
public class Stats {
    ...
    private static final String TAG = "cphelps76/Stats";

    private static final boolean LOCAL_LAUNCH_LOG = true;

    public static final String ACTION_LAUNCH = "com.android.cphelps76.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.android.cphelps76.permission.RECEIVE_LAUNCH_BROADCASTS";
